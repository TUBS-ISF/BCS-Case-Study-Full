...
/**
 * This class represents the constraint which checks if the size of the Alternative-Relation is 0 or bigger than one.
 * @author Sascha Lity
 */
public class MinTwoAlternativeChildConstraint
	...
	public IStatus validate(IValidationContext ctx) {
		...
		if (eType == EMFEventType.NULL) {
			...
			if (eObj instanceof Feature) {
				childs = ((Feature)eObj).getAlternative();
			} 			
