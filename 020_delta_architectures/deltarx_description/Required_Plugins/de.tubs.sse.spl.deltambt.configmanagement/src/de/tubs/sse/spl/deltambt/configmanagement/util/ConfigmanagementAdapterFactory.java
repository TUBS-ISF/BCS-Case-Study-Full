 ...
 * $Id$
 */
package de.tubs.sse.spl.deltambt.configmanagement.util;
...
public class ConfigmanagementAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.tubs.sse.spl.deltambt.configmanagement.ConfigurationRepository <em>Configuration Repository</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.tubs.sse.spl.deltambt.configmanagement.Configuration <em>Configuration</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
