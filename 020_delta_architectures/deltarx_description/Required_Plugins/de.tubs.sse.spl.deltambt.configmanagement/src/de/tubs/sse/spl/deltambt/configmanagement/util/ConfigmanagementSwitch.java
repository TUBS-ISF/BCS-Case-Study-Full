 ...
 * @generated
 */
public class ConfigmanagementSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ConfigmanagementPackage.CONFIGURATION_REPOSITORY: {
			...
			case ConfigmanagementPackage.CONFIGURATION: {
