...
public class FeaturemodelFactoryImpl extends EFactoryImpl implements FeaturemodelFactory {
	...
	public static FeaturemodelFactory init() {
		try {
			FeaturemodelFactory theFeaturemodelFactory = (FeaturemodelFactory)EPackage.Registry.INSTANCE.getEFactory("http://de/tubs/sse/spl/deltambt/featuremodel"); 
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case FeaturemodelPackage.EFEATURE_TYPE:
				return createEFeatureTypeFromString(eDataType, initialValue);
			default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			case FeaturemodelPackage.EFEATURE_TYPE:
				return convertEFeatureTypeToString(eDataType, instanceValue);
			default:
				throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public EFeatureType createEFeatureTypeFromString(EDataType eDataType, String initialValue) {
		EFeatureType result = EFeatureType.get(initialValue);
	 ...
	 * @generated
	 */
	public String convertEFeatureTypeToString(EDataType eDataType, Object instanceValue) {
