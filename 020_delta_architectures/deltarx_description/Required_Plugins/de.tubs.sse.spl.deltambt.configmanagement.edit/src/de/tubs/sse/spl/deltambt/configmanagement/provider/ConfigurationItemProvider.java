...
/**
 * This is the item provider adapter for a {@link de.tubs.sse.spl.deltambt.configmanagement.Configuration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConfigmanagementPackage.Literals.CONFIGURATION__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Configuration_features_feature", "_UI_Configuration_type"),
				 ConfigmanagementPackage.Literals.CONFIGURATION__FEATURES,
				 true,
				 false,
				 true,
				 null,
