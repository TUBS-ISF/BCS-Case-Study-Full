...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Edge Entity</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.tu_bs.cs.isf.familymining.models.base.impl.EdgeEntityImpl#getAlternativeValues <em>Alternative Values</em>}</li>
 *   <li>{@link de.tu_bs.cs.isf.familymining.models.base.impl.EdgeEntityImpl#getVariabilityGroupId <em>Variability Group Id</em>}</li>
 *   <li>{@link de.tu_bs.cs.isf.familymining.models.base.impl.EdgeEntityImpl#getContainingModels <em>Containing Models</em>}</li>
 *   <li>{@link de.tu_bs.cs.isf.familymining.models.base.impl.EdgeEntityImpl#getRelatedVariabilityGroupIds <em>Related Variability Group Ids</em>}</li>
 *   <li>{@link de.tu_bs.cs.isf.familymining.models.base.impl.EdgeEntityImpl#getVariability <em>Variability</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class EdgeEntityImpl extends EntityImpl implements EdgeEntity {
	/**
	...
	protected EClass eStaticClass() {
		return BasePackage.Literals.EDGE_ENTITY;
	}
	...
	public EMap<String, EMap<EStructuralFeature, WrappedType>> getAlternativeValues() {
		if (alternativeValues == null) {
			alternativeValues = new EcoreEMap<String,EMap<EStructuralFeature, WrappedType>>(BasePackage.Literals.STRING_TO_ALTERNATIVE_VALUES_MAP, StringToAlternativeValuesMapImpl.class, this, BasePackage.EDGE_ENTITY__ALTERNATIVE_VALUES);
		}
	...
	public void setVariabilityGroupId(String newVariabilityGroupId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasePackage.EDGE_ENTITY__VARIABILITY_GROUP_ID, oldVariabilityGroupId, variabilityGroupId));
	}
	...
	public EList<String> getContainingModels() {
		if (containingModels == null) {
			containingModels = new EDataTypeUniqueEList<String>(String.class, this, BasePackage.EDGE_ENTITY__CONTAINING_MODELS);
		}
	...
	public EList<String> getRelatedVariabilityGroupIds() {
		if (relatedVariabilityGroupIds == null) {
			relatedVariabilityGroupIds = new EDataTypeUniqueEList<String>(String.class, this, BasePackage.EDGE_ENTITY__RELATED_VARIABILITY_GROUP_IDS);
		}
	...
	public void setVariability(Variability newVariability) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasePackage.EDGE_ENTITY__VARIABILITY, oldVariability, variability));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BasePackage.EDGE_ENTITY__ALTERNATIVE_VALUES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case BasePackage.EDGE_ENTITY__VARIABILITY_GROUP_ID:
				return getVariabilityGroupId();
			case BasePackage.EDGE_ENTITY__CONTAINING_MODELS:
				return getContainingModels();
			case BasePackage.EDGE_ENTITY__RELATED_VARIABILITY_GROUP_IDS:
				return getRelatedVariabilityGroupIds();
			case BasePackage.EDGE_ENTITY__VARIABILITY:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == VariableValueElement.class) {
			switch (derivedFeatureID) {
				case BasePackage.EDGE_ENTITY__ALTERNATIVE_VALUES: return BasePackage.VARIABLE_VALUE_ELEMENT__ALTERNATIVE_VALUES;
				default: return -1;
			}
		}
		if (baseClass == VariableElement.class) {
			switch (derivedFeatureID) {
				case BasePackage.EDGE_ENTITY__VARIABILITY_GROUP_ID: return BasePackage.VARIABLE_ELEMENT__VARIABILITY_GROUP_ID;
				case BasePackage.EDGE_ENTITY__CONTAINING_MODELS: return BasePackage.VARIABLE_ELEMENT__CONTAINING_MODELS;
				case BasePackage.EDGE_ENTITY__RELATED_VARIABILITY_GROUP_IDS: return BasePackage.VARIABLE_ELEMENT__RELATED_VARIABILITY_GROUP_IDS;
				case BasePackage.EDGE_ENTITY__VARIABILITY: return BasePackage.VARIABLE_ELEMENT__VARIABILITY;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == VariableValueElement.class) {
			switch (baseFeatureID) {
				case BasePackage.VARIABLE_VALUE_ELEMENT__ALTERNATIVE_VALUES: return BasePackage.EDGE_ENTITY__ALTERNATIVE_VALUES;
				default: return -1;
			}
		}
		if (baseClass == VariableElement.class) {
			switch (baseFeatureID) {
				case BasePackage.VARIABLE_ELEMENT__VARIABILITY_GROUP_ID: return BasePackage.EDGE_ENTITY__VARIABILITY_GROUP_ID;
				case BasePackage.VARIABLE_ELEMENT__CONTAINING_MODELS: return BasePackage.EDGE_ENTITY__CONTAINING_MODELS;
				case BasePackage.VARIABLE_ELEMENT__RELATED_VARIABILITY_GROUP_IDS: return BasePackage.EDGE_ENTITY__RELATED_VARIABILITY_GROUP_IDS;
				case BasePackage.VARIABLE_ELEMENT__VARIABILITY: return BasePackage.EDGE_ENTITY__VARIABILITY;
				default: return -1;
			}
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == VariableValueElement.class) {
			switch (baseOperationID) {
				case BasePackage.VARIABLE_VALUE_ELEMENT___ADD_ALTERNATIVE_VALUES_MAP__STRING: return BasePackage.EDGE_ENTITY___ADD_ALTERNATIVE_VALUES_MAP__STRING;
				default: return -1;
			}
		}
		if (baseClass == VariableElement.class) {
			switch (baseOperationID) {
				case BasePackage.VARIABLE_ELEMENT___IS_CONTAINED_IN_MODEL__STRING: return BasePackage.EDGE_ENTITY___IS_CONTAINED_IN_MODEL__STRING;
				case BasePackage.VARIABLE_ELEMENT___IS_MANDATORY: return BasePackage.EDGE_ENTITY___IS_MANDATORY;
				case BasePackage.VARIABLE_ELEMENT___IS_ALTERNATIVE: return BasePackage.EDGE_ENTITY___IS_ALTERNATIVE;
				case BasePackage.VARIABLE_ELEMENT___IS_OPTIONAL: return BasePackage.EDGE_ENTITY___IS_OPTIONAL;
				case BasePackage.VARIABLE_ELEMENT___IS_OPTIONAL_ALTERNATIVE: return BasePackage.EDGE_ENTITY___IS_OPTIONAL_ALTERNATIVE;
				case BasePackage.VARIABLE_ELEMENT___IS_VARIABILITY_SET: return BasePackage.EDGE_ENTITY___IS_VARIABILITY_SET;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case BasePackage.EDGE_ENTITY___IS_CONTAINED_IN_MODEL__STRING:
				return isContainedInModel((String)arguments.get(0));
			case BasePackage.EDGE_ENTITY___IS_MANDATORY:
				return isMandatory();
			case BasePackage.EDGE_ENTITY___IS_ALTERNATIVE:
				return isAlternative();
			case BasePackage.EDGE_ENTITY___IS_OPTIONAL:
				return isOptional();
			case BasePackage.EDGE_ENTITY___IS_OPTIONAL_ALTERNATIVE:
				return isOptionalAlternative();
			case BasePackage.EDGE_ENTITY___IS_VARIABILITY_SET:
				return isVariabilitySet();
			case BasePackage.EDGE_ENTITY___ADD_ALTERNATIVE_VALUES_MAP__STRING:
