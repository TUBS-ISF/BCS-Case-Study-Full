...
setwd("C:/Users/t.pett/Documents/01_Research/004_ciaToolsuite/BCS_history/02_bcs_t2/eval")
show(getwd())
...
### write to pdf
 pdf(file='./plots/riskPrio_t2.pdf', width=10, height=10)

boxplot(unsortedChvatal, sortedChvatal, placeholder, unsortedICPL, sortedICPL, placeholder, unsortedRandom, sortedRandom,
     las=2, ylim=c(0,0.6),main="Risk Prioritization Scores First Evolution Step of BCS", ylab = "High Risk Feature Coverage Score", cex.lab =1.3,
     axes=FALSE,
...
axis(2,
     ...
     at=c(0,0.05,0.1,0.15,0.2,0.25,0.3,0.35,0.4,0.45,0.5,0.55,0.6),
      labels=c("0","0.05","0.1","0.15","0.2","0.25","0.3","0.35","0.4","0.45","0.5","0.55","0.6"),
     las=1 )
axis(3,
     pos=c(0.6,0),
