...
setwd("C:/Users/t.pett/Documents/01_Research/004_ciaToolsuite/BCS_history/01_bcs_t1/eval")
show(getwd())
...
### write to pdf
 pdf(file='./plots/riskPrio_t1.pdf', width=10, height=10)

boxplot(unsortedChvatal, sortedChvatal, placeholder, unsortedICPL, sortedICPL, placeholder, unsortedRandom, sortedRandom,
     las=2, ylim=c(0,0.5),main="Risk Prioritization Scores First Evolution Step of BCS", ylab = "High Risk Feature Coverage Score", cex.lab =1.3,
     axes=FALSE,
